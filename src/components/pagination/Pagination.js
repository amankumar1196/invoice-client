...
const Pagination = (props) => {
  const { filters, currentTotalRecords, filterHook, pagination: { totalPages, currentPage, totalRecords }, infoTextDisplay } = props;
  ...
  return(
    totalRecords > 5 && <div className={`pagination-container d-flex flex-row align-items-center justify-content-${infoTextDisplay ? "between" : "end"}`}>
